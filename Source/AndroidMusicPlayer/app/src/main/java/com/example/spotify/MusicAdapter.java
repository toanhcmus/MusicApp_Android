...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyVieHolder>/* implements Filterable */{
    ...
    MusicAdapter(Context mContext, ArrayList<MusicFiles> mFiles, boolean mode) {
    ...
    public MyVieHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (isDarkMode)
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.music_items_light_mode, parent, false);
